...
/* Copyright (C) 2012, 2014, 2017-2018, 2021, 2023-2024 D. R. Commander.
 *                                                      All Rights Reserved.
...
static Bool isBefore(const struct timeval *first, const struct timeval *second)
{
...
static _X_INLINE Bool isAfter(unsigned a, unsigned b)
{
