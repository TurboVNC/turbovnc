...
9. Fixed an issue whereby, when using certain Command-{key} sequences in the
...
11. The `-list` option for the vncserver script no longer lists orphaned
...
12. Fixed an issue in the Java TurboVNC Viewer whereby, when using SSH
