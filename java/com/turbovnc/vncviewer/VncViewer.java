...
public final class VncViewer implements Runnable, OptionsDialogCallback {
  ...
  public static void usage() {
    String usage = "\n" +
      ...
      "display number or TCP port on the specified host.  This mode of operation does\n" +
      "not require the TurboVNC Server.\n" +
      "\n" +
      ...
      "      info file, which has an extension of .vnc, can be generated by selecting\n" +
      "      \"Save connection info as...\" in the system menu of the Windows TurboVNC\n" +
      "      Viewer in TurboVNC 2.2.x and prior.  Connection info files will, when\n" +
      "      opened on Windows or macOS or dragged & dropped onto the TurboVNC Viewer\n" +
      "      icon, launch the TurboVNC Viewer and initiate a new connection.\n" +
      "\n" +
