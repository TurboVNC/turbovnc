...
public class VncViewer implements Runnable, OptionsDialogCallback {
  ...
  public static void usage() {
    String usage = "\n" +
      ...
      "      Viewer.  Connection info files will, when opened on Windows or macOS or\n" +
      "      dragged & dropped onto the TurboVNC Viewer icon, launch the TurboVNC\n" +
      "      Viewer and initiate a new connection.\n" +
      "\n" +
