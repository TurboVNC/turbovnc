...
This package includes the TurboVNC Viewer, which provides optimal performance when connecting to TurboVNC servers.  Java 1.5 or later (which is installed by default on OS X 10.6 Snow Leopard and earlier but not on OS X 10.7 Lion and later) is required.
