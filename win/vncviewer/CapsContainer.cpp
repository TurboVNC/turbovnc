...
void CapsContainer::Add(CARD32 code, const char *vendor, const char *name,
                        const char *desc)
{
...
void CapsContainer::Add(const rfbCapabilityInfo *capinfo, const char *desc)
{
...
bool CapsContainer::GetInfo(CARD32 code, rfbCapabilityInfo *capinfo)
{
  if (IsKnown(code)) {
...
char *CapsContainer::GetDescription(CARD32 code)
{
...
bool CapsContainer::IsEnabled(CARD32 code)
{
...
CARD32 CapsContainer::GetByOrder(int idx)
{
